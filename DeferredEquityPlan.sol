...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= fakenow, "You tryna scam us? try harder");
        require(distributed_shares < total_shares, "bruh we ain't giving you more than what we said we would");
